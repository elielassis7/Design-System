...
var { styled, css, config, getCssText, globalCss, keyframes, theme, createTheme } = (0, import_react.createStitches)({
...
function Tooltip2({ date, status }) {
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(TooltipProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(TooltipContainer, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(TooltipTrigger, {}),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(TooltipPortal, { children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(TooltipContent, { sideOffset: 5, children: [
      `${(0, import_date_fns.format)(date, "dd 'de' MMMM", { locale: import_locale.ptBR })} - ${status}`,
